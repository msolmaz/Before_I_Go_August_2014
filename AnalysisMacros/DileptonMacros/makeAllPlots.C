...
//TString signal1("CombinedFiles/Chi0ToNuLL_MSquark1000_MChi148_combined_");
 ...
 TString signal2("CombinedFiles/HTo2LongLivedTo4F_MH125_MFF20_CTau13To1300_combined_");
...
*/
  totalBkgMCIntegral += addHistogram("CombinedFiles/Diboson_combined_"+anaType+".root", histoName, kCyan-7, stack,"#splitline{Diboson}{& WJets}", legend, lumi, minIntegral, maxIntegral );
  totalBkgMCIntegral += addHistogram("CombinedFiles/TTJets_combined_"+anaType+".root", histoName, 3, stack,"t#bar{t}", legend, lumi, minIntegral, maxIntegral );
  totalBkgMCIntegral += addHistogram("CombinedFiles/Tau_combined_"+anaType+".root", histoName+"_tau", 46, stack,"Z/#gamma#rightarrow#tau^{+}#tau^{-}", legend, lumi, minIntegral, maxIntegral );
  totalBkgMCIntegral += addHistogram("CombinedFiles/DYJets_combined_"+anaType+".root", histoName, 2, stack,"Z/#gamma#rightarrow#mu^{+}#mu^{-}", legend, lumi, minIntegral, maxIntegral );
  totalBkgMCIntegral += addHistogram("CombinedFiles/QCDenriched_combined_"+anaType+".root", histoName, 4, stack,"QCD", legend, lumi, minIntegral, maxIntegral );
...
//  if ( plotData == false ) makeRatioPlot = false;
    ...
    makePlot("Lxy_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.92,
...
//           lumi, plotData, pdfOutputFile, makeRatioPlot );
      ...
      makePlot("nMinus1_deltaR_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.92,
...
//         lumi, plotData, pdfOutputFile, makeRatioPlot );
    ...
    makePlot("nMinus1_minValidStations_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          ...
          plotCutValue, 3,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_minValidHits_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Minimum Valid Muon Hits", 0, 55, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 17,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_minValidDTHits_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Minimum Valid Muon DT Hits", 0, 55, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 17,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_minValidCSCHits_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Minimum Valid Muon CSC Hits", 0, 55, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 17,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_cosine_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "cosine", -1, 1, 0.1, 5000*yMaxFactor, true,
          plotCutValue, -0.75,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_DileptonAbsLxySig_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Absolute L_{xy} Significance", 0, 40, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 12,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_AbsLeptonD0_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Minimum Absolute d_{0}/#sigma ", 0, 30, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 4,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_AbsD0_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Minimum Absolute d_{0} ", 0, 150, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 4,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_AbsDZ_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Minimum Absolute d_{Z} ", 0, 50, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 4,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    makePlot("nMinus1_AbsDZSignificance_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Minimum Absolute d_{Z}/#sigma ", 0, 50, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 4,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
    if ( anaType == "2muTrack" || anaType == "2saMu" ) {
      makePlot("nMinus1_vertexChi2_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          vertexChi2, 0, 20, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 4,
          lumi, plotData, pdfOutputFile, makeRatioPlot );

      makePlot("nMinus1_maxTrackChi2_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Maximum track #chi^{2}/ndof", 0, 20, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 2,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
      makePlot("nMinus1_muonTimeC_inverseBeta_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Inverse Beta", -5, 5, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 3,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
      makePlot("nMinus1_muonTimeC_freeInverseBeta_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Free Inverse Beta", -5, 5, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 3,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
      makePlot("nMinus1_muonTimeC_timeAtIpInOut_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
          "Time At IP In Out (ns)", -40, 40, 0.1, 5000*yMaxFactor, true,
          plotCutValue, 3,
          lumi, plotData, pdfOutputFile, makeRatioPlot );
      makePlot("nMinus1_muonTimeC_timeAtIpOutIn_"+cuts, outputFile, anaType, 0.6, 0.7, 0.9, 0.93,
