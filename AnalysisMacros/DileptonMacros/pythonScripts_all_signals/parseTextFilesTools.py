...
#                print ("channel1 & channel2 & ctau1 = ", exotic.ctau1, "channel1 & channel2 & ctau2 = ", exotic.ctau2 )
#                print ("first = ", getLifetimeWeight( lifeTimeFact,originalCtau,float(exotic.ctau1) ))
#                print ("second = ", getLifetimeWeight( lifeTimeFact,originalCtau,float(exotic.ctau2) ))
...
#                    print ("channel1 & ctau1 = ", exotic.ctau1, "channel1 & originalCtau = ", originalCtau)
                    lifeTimeWeight = getLifetimeWeight( lifeTimeFact,originalCtau,float(exotic.ctau1) )
                    exoticCtau1 = exotic.ctau1
                    if exotic.ctau1 > maxCtau : maxCtau = exotic.ctau1
                    pass
                elif exotic.channel2 == channel :
#                    print ("channel2 & ctau2 = ", exotic.ctau1, "channel2 & originalCtau = ", originalCtau)
