//
// File generated by rootcint at Sat Jun 28 19:53:36 2014
...
void TreeDipseudoLeptonCandidate::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "leptonD0L_PVrefitCorr", &leptonD0L_PVrefitCorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "leptonD0H_PVrefitCorr", &leptonD0H_PVrefitCorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "leptonD0SignificanceL_PVrefit_includingPVErrorCorr", &leptonD0SignificanceL_PVrefit_includingPVErrorCorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "leptonD0SignificanceH_PVrefit_includingPVErrorCorr", &leptonD0SignificanceH_PVrefit_includingPVErrorCorr);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "deltaRSMS", &deltaRSMS);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "distanceSMS", &distanceSMS);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "cosineCorr", &cosineCorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "deltaRCorr", &deltaRCorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "deltaRSMSCorr", &deltaRSMSCorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "distanceSMSCorr", &distanceSMSCorr);
...
static void G__setup_memvarTreeDipseudoLeptonCandidate(void) {
   ...
   G__memvar_setup((void*)((long)(&p->leptonD0L_PVrefitCorr)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"leptonD0L_PVrefitCorr=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->leptonD0H_PVrefitCorr)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"leptonD0H_PVrefitCorr=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->leptonD0SignificanceL_PVrefit_includingPVErrorCorr)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"leptonD0SignificanceL_PVrefit_includingPVErrorCorr=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->leptonD0SignificanceH_PVrefit_includingPVErrorCorr)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"leptonD0SignificanceH_PVrefit_includingPVErrorCorr=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)((long)(&p->deltaRSMS)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"deltaRSMS=",0,"at the second muon station for trigger inefficiencies. Leave unbiased as above.");
   G__memvar_setup((void*)((long)(&p->distanceSMS)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"distanceSMS=",0,"distance between the positions of the two leptons at the second muon station.");
   G__memvar_setup((void*)((long)(&p->cosineCorr)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"cosineCorr=",0,"to reject cosmics, use the refitted leptons.");
   G__memvar_setup((void*)((long)(&p->deltaRCorr)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"deltaRCorr=",0,"for trigger inefficiencies, use the refitted leptons.");
   G__memvar_setup((void*)((long)(&p->deltaRSMSCorr)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"deltaRSMSCorr=",0,"at the second muon station for trigger inefficiencies, use the refitted leptons.");
   G__memvar_setup((void*)((long)(&p->distanceSMSCorr)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"distanceSMSCorr=",0,"distance between the positions of the two refitted leptons at the second muon station.");
